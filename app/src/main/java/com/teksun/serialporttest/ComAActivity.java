...
import com.teksun.bean.AssistBean;
import com.teksun.bean.ComBean;
 ...
 * n,8,1，没得选
 */
public class ComAActivity extends Activity {
...
//		}
    ...
    private void DispRecData(ComBean ComRecData){
        ...
        String temp=MyFunc.ByteArrToHex(ComRecData.bRec);


        //String[] temp = {MyFunc.ByteArrToHex(ComRecData.bRec)};
        //Toast.makeText(ComAActivity.this,"temp00="+temp+"9999",Toast.LENGTH_SHORT).show();
        //Toast.makeText(ComAActivity.this,"temp=="+temp,Toast.LENGTH_SHORT).show();
        if (temp.equals("55 AA 10 01 00 11 ")) {
            //开关机键
            sendKeyEvent(26);
            Toast.makeText(ComAActivity.this,"按下开关机键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 02 00 18 ")) {
            //静音键
            sendKeyEvent(164);
            Toast.makeText(ComAActivity.this,"按下静音键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 05 00 1B ")) {
            //上键
            sendKeyEvent(19);
            Toast.makeText(ComAActivity.this,"按下上键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 06 00 1C ")) {
            //下键
            sendKeyEvent(20);
            Toast.makeText(ComAActivity.this,"按下下键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 07 00 1D ")) {
            //左键
            sendKeyEvent(21);
            Toast.makeText(ComAActivity.this,"按下左键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 08 00 1E ")) {
            //右键
            sendKeyEvent(22);
            Toast.makeText(ComAActivity.this,"按下右键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 09 00 1F ")) {
            //OK键
            sendKeyEvent(66);
            Toast.makeText(ComAActivity.this,"按下OK键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 0A 00 20 ")) {
            //返回键
            sendKeyEvent(4);
            Toast.makeText(ComAActivity.this,"按下返回键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 0B 00 21 ")) {
            //home键
            sendKeyEvent(3);
            Toast.makeText(ComAActivity.this,"按下home键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 0C 00 22 ")) {
            //menu键
            sendKeyEvent(82);
            Toast.makeText(ComAActivity.this,"按下menu键....",Toast.LENGTH_SHORT).show();
        }else if (temp.equals("55 AA 16 04 00 1A ")) {
            //sendPortData(ComA, "AA 55 E0 00 00 E0 ");
            //AssistData.setSendA("AA 55 E0 00 00 E0 ");
            //SetLoopData(ComA, "AA 55 E0 00 00 E0 ");
            //音量-键
            sendKeyEvent(25);
            Toast.makeText(ComAActivity.this,"按下音量-键....",Toast.LENGTH_SHORT).show();
